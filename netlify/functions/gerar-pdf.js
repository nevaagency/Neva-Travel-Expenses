...
async function generatePDF(payload) {
  ...
  // NIF + assinatura row
  drawRect(ML, y - ROW_H + 3, TW, ROW_H, BG1);
  page.drawLine({ start: { x: ML, y: y - ROW_H + 3 }, end: { x: ML + TW, y: y - ROW_H + 3 }, thickness: 0.3, color: BORD });
